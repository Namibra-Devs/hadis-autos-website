        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="flex items-center justify-between h-20">
            ...
            >
              {navItems.map((item) => (
                <NavLink
                  ...
                  to={item.path}
                  className={({ isActive }) => `
                    relative font-medium text-black no-underline 
                    transition-colors duration-300 group py-2
                    ${isActive ? "text-red-800" : "hover:text-red-500"}
                  `}
                ...
                >
                  ...
                  <span
                    className={`
                    absolute bottom-0 left-0 w-0 h-0.5 bg-gradient-to-r from-red-500 to-red-700
                  ...
                  <span
                    className="
                    absolute inset-0 bg-gradient-to-r from-red-50 to-transparent 
            ...
            <div className="hidden lg:flex items-center space-x-6">
              ...
              <a
                href="tel:+1234567890"
                className="flex items-center space-x-2 text-gray-700 hover:text-red-700 no-underline group/phone hover:scale-105 transition-transform duration-300"
              ...
              >
                <span className="relative z-10 flex items-center">
                  <svg
                    className="w-5 h-5 mr-2 transition-transform duration-300 group-hover/btn:scale-110"
                    fill="currentColor"
                    viewBox="0 0 24 24"
                  >
