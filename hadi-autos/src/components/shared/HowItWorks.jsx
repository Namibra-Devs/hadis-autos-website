import { Search, Car, Ship, CheckCircle, ArrowRight, Users, Clock, Shield, Star } from 'lucide-react'
          ...
          {[
            ...
            return (
              <div key={index} className="text-center">
                ...
                <div className="text-xs lg:text-sm text-amber-100/60">{stat.label}</div>
              </div>
            )
          })}
        </motion.div>
