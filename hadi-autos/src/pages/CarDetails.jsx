...
const CarDetails = () => {
  ...
  // Find vehicle by ID
  const vehicle =
    vehicleData.find((v) => v.id === parseInt(id)) || vehicleData[0];
  ...
  const specifications = [
    ...
    {
      label: "Location",
      value: vehicle.location === "canada" ? "Canada" : "Ghana",
    },
    {
      label: "Stock ID",
      value: `HAD-${vehicle.id.toString().padStart(4, "0")}`,
    },
  ...
  return (
    <div className="container mx-auto px-4 py-8 lg:py-12 mt-20">
      ...
      <div className="mb-6 flex items-center gap-2 text-sm">
        <Link
          to="/"
          className="text-gray-500 hover:text-[#3b2a1f] transition-colors bg-black p-2 rounded-md text-white cursor-pointer hover:bg-red-600 hover:text-white  transition-colors"
        >
          Home
        </Link>
        ...
        <Link
          to="/cars"
          className="text-gray-500 hover:text-[#3b2a1f] bg-red-600 p-2 rounded-md text-white cursor-pointer hover:bg-black hover:text-white transition-colors"
        >
          Inventory
        </Link>
        <ChevronRight className="w-3 h-3 text-gray-400" />
...
>
  <ChevronRight className="w-5 h-5" />
              ...
              <div className="absolute top-4 left-4">
                <Badge
                  variant={
                    vehicle.location === "canada" ? "primary" : "success"
                  }
  ...
  <div className="text-2xl md:text-lg text-left font-bold text-[#3b2a1f]">
    ${vehicle.price.toLocaleString()}
  </div>

  {vehicle.location === 'canada' && vehicle.shipmentIncluded && (
    <div className="flex items-left text-xs text-green-600 mt-1">
     
      <span className="text-left">Shipment included</span>
    </div>
  )}
</div>
                  ...
                  {vehicle.shipmentIncluded ? (
                    <>
                      ...
                      <span className="text-sm text-gray-700">
                        Shipment to Ghana is included in the price. Door-to-door
                    ...
                    <>
                      ...
                      <span className="text-sm text-gray-700">
                        Shipment cost is not included. Contact us for a shipping
              ...
              {selectedTab === "overview" && (
                <div className="space-y-4">
                  <p className="text-gray-700 leading-relaxed">
                    This {vehicle.title} is a premium vehicle available for
                    import to Ghana. It has been thoroughly inspected and comes
                    with complete documentation. Perfect for buyers looking for
                    quality and reliability in the Ghanaian market.
                  </p>
